...
pub const setProtoTag = @import("stack_pool_sticker.zig").setProtoTag;
pub const getProtoTag = @import("stack_pool_sticker.zig").getProtoTag;
pub const sniffProto = @import("stack_pool_sticker.zig").sniffProto;
